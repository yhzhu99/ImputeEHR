...
train_ds, val_test_ds = train_test_split(ds, train_size=train_size, random_state=random_seed)
val_ds, test_ds = train_test_split(val_test_ds, train_size=val_size/(val_size+test_size), random_state=random_seed)
